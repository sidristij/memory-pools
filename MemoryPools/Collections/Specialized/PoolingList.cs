...
{
	public abstract class PoolingListBase<TPoolingList, T> : PoolingList<T> where TPoolingList : PoolingListBase<TPoolingList, T>
	{
		public PoolingListBase() => Init();

		/// <summary>
		/// Ctor for objects, who were got from pool
		/// </summary>
	...
	public abstract class PoolingList<T> : IDisposable, IList<T>
	{
