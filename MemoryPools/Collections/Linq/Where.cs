...
namespace MemoryPools.Collections.Linq
{
	public static partial class EnumerableEx
	{
		...
		{
			return Heap.Get<WhereClauseEnumerable<T>>().Init(source, condition);
		}
		...
		{
			return Heap.Get<WhereClauseWithContextEnumerable<T, TContext>>().Init(source, context, condition);
		}
	}
}